/**
 * REV: 06.16.16b, HICi3-1.1.0-RC6-Bugfix, downloaded from Github archive.
 *
...
#define INVERT_Y_DIR false // CL: for HIC i3 =false, was =true
#define INVERT_Z_DIR true // CL: for HIC i3 =true, was =fals
...
//
#define REPRAP_DISCOUNT_SMART_CONTROLLER // CL: HiIC i3 LCD default 20x4 Controller/Display, was =not enabled
